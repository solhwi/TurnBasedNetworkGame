...
public class Room : MonoBehaviourPunCallbacks
{
    ...
    StateMachine<Room> stateMachine;
    ...
    void Start()
    {
        ...
        else
        {
            ...
            stateMachine = new StateMachine<Room>(new RoomState_NephewLobby(this, RoomState.NEPHEWLOBBY));
        }
    }
    ...
    public void ChangeState(RoomState nextState, bool ret = false)
    {
        ...
        switch (nextState)
        {
            ...
            case RoomState.NEPHEWLOBBY:
                stateMachine.ChangeState(new RoomState_NephewLobby(this, RoomState.NEPHEWLOBBY), StateMachine<Room>.StateTransitionMethod.JustPush);
                break;
